...
class _AquaWatchAppState extends State<AquaWatchApp> {
  ...
  void _changeLanguage(String language) {
    ...
    // Here you would typically call your API to update language preference
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LogoToLoginPage(onThemeChanged: _changeTheme),
  ...
  ThemeData _buildLightTheme() {
    return ThemeData(
      ...
      textTheme: TextTheme(
      titleLarge: TextStyle(color: Color(0xFF1F2937)), // Changed from headline6
    ),
  ...
  ThemeData _buildDarkTheme() {
    return ThemeData(
      ...
      textTheme: TextTheme(
      titleLarge: TextStyle(color: Color(0xFFF1F5F9)), // Changed from headline6
    ),
          ...
          child: AnimatedBuilder(
            ...
            builder: (context, child) {
              return Transform.translate(
                offset: Offset(0, MediaQuery.of(context).size.height * _logoPosition.value.dy),
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget _buildThemeToggle(BuildContext context, bool isDark) {
    return Switch(
      ...
      inactiveThumbColor: Color(0xFF4689C8),
    );
  }
  ...
  Widget _buildAlertCard(String title, String message, IconData icon, Color color, bool isDark) {
    return Container(
      padding: EdgeInsets.all(16),
      decoration: BoxDecoration(
...
class _AnalyticsScreenState extends State<AnalyticsScreen>
  ...
  Future<void> _downloadReport() async {
    try {
      ...
      final url = 'https://example.com/report.pdf'; // Replace with your API endpoint
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  Future<void> _updateLanguagePreference(String language) async {
    // Here you would call your secure API to update the language preference
    try {
      // Simulate API call
      await Future.delayed(Duration(seconds: 1));
      ScaffoldMessenger.of(context).showSnackBar(
...
class ContactSupportScreen extends StatelessWidget {
  ...
  Widget _buildContactMethod(IconData icon, String title, String subtitle, bool isDark) {
    return Row(
      children: [
...
class LogoToLoginPage extends StatefulWidget {
  final Function(ThemeMode) onThemeChanged;

  const LogoToLoginPage({Key? key, required this.onThemeChanged}) : super(key: key);

  @override
  _LogoToLoginPageState createState() => _LogoToLoginPageState();
}

class _LogoToLoginPageState extends State<LogoToLoginPage> {
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      ...
      body: Center(
        child: CircleAvatar(
          ...
          backgroundImage: AssetImage('assets/logo.png'), // Add this image in assets
        ),
      ),
    );
  }
