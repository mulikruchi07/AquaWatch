...
class InitialScreen extends StatefulWidget {
  ...
  const InitialScreen({Key? key, required this.onThemeChanged}) : super(key: key);
          ...
          child: AnimatedBuilder(
            ...
            builder: (context, child) {
              return Container(
                ...
                child: Stack(
                  children: [
                    // Tank outline with curved edges and rim
                    Container(
                      decoration: BoxDecoration(
  ...
  Widget _buildThemeOption(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: isSelected ? Color(0xFF4689C8) : (isDark ? Color(0xFF94A3B8) : Color(0xFF6B7280))),
            SizedBox(height: 8),
            Text(
              label,
              style: TextStyle(
                color: isSelected ? Color(0xFF4689C8) : (isDark ? Color(0xFFF1F5F9) : Color(0xFF1F2937)),
              ),
            ),
          ],
        ),
